...
?>
	...
	<script type="text/javascript">
			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						border:false,
						cache:true,
						href:'<?php echo JURI::root( true ) ?>/newfiles/admin/district/form_district.php?index='+index,
						onLoad:function(){
		...
		function saveItem(index){
			...
			var url = row.isNewRecord ? '<?php echo JURI::root( true ) ?>/newfiles/admin/district/save_district.php' : '<?php echo JURI::root( true ) ?>/newfiles/admin/district/update_district.php?id='+row.id;
			...
			if (row){
				$.messager.confirm('Confirm','Are you sure you want to remove this department?',function(r){
					if (r){
						...
						$.post('<?php echo JURI::root( true ) ?>/newfiles/admin/district/delete_district.php',{id:row.id},function(s){
...
<body>
	...
	<table id="dg" title="My Users" style="width:700px;height:500px"
			url="<?php echo JURI::root( true ) ?>/newfiles/admin/district/get_districts.php"
