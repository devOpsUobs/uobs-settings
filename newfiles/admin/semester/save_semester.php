...
$sql = "INSERT INTO `kiusc_semesters`( `sem_name`, `start_date`, `mid_term_date`, `final_term_date`, `course_offer`, `course_reg`, `mid_term`, 
`final_term`, `active`, `result_declare`, `result_date`) VALUES ('$sem_name','$start_date','$mid_term_date', '$final_term_date', 
'$course_offer', '$course_reg','$mid_term','$final_term','$active','result_declare','result_date')";
