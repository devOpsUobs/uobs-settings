...
?>
	...
	<script type="text/javascript">
			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						border:false,
						cache:true,
						href:'<?php echo JURI::root( true ) ?>/newfiles/admin/tehsil/form_tehsil.php?index='+index,
						onLoad:function(){
		...
		function saveItem(index){
			...
			var url = row.isNewRecord ? '<?php echo JURI::root( true ) ?>/newfiles/admin/tehsil/save_tehsil.php' : '<?php echo JURI::root( true ) ?>/newfiles/admin/tehsil/update_tehsil.php?id='+row.id;
			...
			if (row){
				$.messager.confirm('Confirm','Are you sure you want to remove this program?',function(r){
					if (r){
						...
						$.post('<?php echo JURI::root( true ) ?>/newfiles/admin/tehsil/delete_tehsil.php',{id:row.id},function(s){
...
<body>
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<div>Manage tehsils</div>
	</div>
	
	
	<table id="dg" title="My Users" style="width:700px;height:500px"
			url="<?php echo JURI::root( true ) ?>/newfiles/admin/tehsil/get_tehsils.php"
			toolbar="#toolbar" pagination="false"
			fitColumns="true" singleSelect="true">
		<thead>
			<tr>
				<th field="name" width="50">Tehsil Name</th>
                <th field="district_name" width="50">District</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
