						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-md-5 xs-margin-30px-bottom">
								<div class="team-single-img">
									<img src="<?php echo ($emp['picture'] != "") ? 'newfiles/jobs/pictures/' . $emp['picture'] : 'newfiles/jobs/pictures/pic.jpg'; ?>" alt="" class="img-thumbnail mx-auto d-block rounded-circle" width="150px" height="150px">
								</div>
