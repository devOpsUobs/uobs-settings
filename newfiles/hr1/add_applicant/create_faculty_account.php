...
if(isset($_POST['save']) || isset($_POST['save_next']))
{
	...
	// $cnic_compare = $_POST['cnic_compare'];
	// echo $cnic_compare.'sssss<br>';
	$is_current=0;
	...
	if($employee > 0)
	{
		if($img_path != NULL)
		{
			mysqli_query($conn, "UPDATE `kiusc_employees` SET `emp_no`= '$employee_no',`first_name`='$first_name',`last_name`='$last_name',`fname`='$fname',`email`='$email',`cnic`='$cnic',`passport_no`='$passport_no',`cell_no1`='$cell_no1',`cell_no2`='$cell_no2',`nationality`='$nationality',`permanant_address`='$permanent_address',`current_address`='$current_address',`city_town`='$city_town',`tehsil`='$tehsil',`district`='$district',`country`='$country',`gender`='$gender',`marital_status`='$marital_status',`dob`='$dob',`official_email`='$official_email',`bank_id`='$bank_id',`account_no`='$account_no',`official_phone_no`='$official_phone_no', `designation_id`='$designation_id',`acc_department_id`='$acc_department_id',`adm_department_id`='$adm_department_id',`date_of_joining`='$date_of_joining',`service_end_date`='$service_end_date',`employment_nature`='$employment_nature',`contract_period_months`='$contract_period_months',`mode_of_employment`='$mode_of_employment',`employment_scale`='$employment_scale', `pay_scale` = '$pay_scale',`picture`='$img_path', `is_payroll` = '$is_payroll',`is_active` = '$is_active' WHERE id='$emp_id'"); 

			mysqli_query($conn, "UPDATE `kiusc_emp_designations` SET `designation_id`='$designation_id',`acc_department_id`='$acc_department_id',`adm_department_id`='$adm_department_id',`date_of_joining`='$date_of_joining',`service_end_date`='$service_end_date',`employment_nature`='$employment_nature',`contract_period_months`='$contract_period_months',`mode_of_employment`='$mode_of_employment',`employment_scale`='$employment_scale', `pay_scale` = '$pay_scale',`is_current`='$is_current',`is_initial`='1' WHERE is_initial=1 and emp_id='$emp_id'"); 

			print "<font color='green'> Record Updated Successfully </font>";
		}
		else
		{
			mysqli_query($conn, "UPDATE `kiusc_employees` SET `emp_no`= '$employee_no',`first_name`='$first_name',`last_name`='$last_name',`fname`='$fname',`email`='$email',`cnic`='$cnic',`passport_no`='$passport_no',`cell_no1`='$cell_no1',`cell_no2`='$cell_no2',`nationality`='$nationality',`permanant_address`='$permanent_address',`current_address`='$current_address',`city_town`='$city_town',`tehsil`='$tehsil',`district`='$district',`country`='$country',`gender`='$gender',`marital_status`='$marital_status',`dob`='$dob',`official_email`='$official_email',`bank_id`='$bank_id',`account_no`='$account_no',`official_phone_no`='$official_phone_no', `designation_id`='$designation_id',`acc_department_id`='$acc_department_id',`adm_department_id`='$adm_department_id',`date_of_joining`='$date_of_joining',`service_end_date`='$service_end_date',`employment_nature`='$employment_nature',`contract_period_months`='$contract_period_months',`mode_of_employment`='$mode_of_employment',`employment_scale`='$employment_scale', `pay_scale` = '$pay_scale' , `is_payroll` = '$is_payroll',`is_active` = '$is_active' WHERE cnic='$cnic'");
			
			mysqli_query($conn, "UPDATE `kiusc_emp_designations` SET `designation_id`='$designation_id',`acc_department_id`='$acc_department_id',`adm_department_id`='$adm_department_id',`date_of_joining`='$date_of_joining',`service_end_date`='$service_end_date',`employment_nature`='$employment_nature',`contract_period_months`='$contract_period_months',`mode_of_employment`='$mode_of_employment',`employment_scale`='$employment_scale', `pay_scale` = '$pay_scale',`is_current`='$is_current',`is_initial` WHERE is_initial=1 and emp_id='$emp_id'");
			
			print "<font color='green'> Record Updated Successfully </font>";
		}

		$emp_desg=mysqli_query($conn, "SELECT * FROM `kiusc_emp_designations` where emp_id='$edit_emp_id'");
		$emp_desg=mysqli_num_rows($emp_desg);
		if($emp_desg == 0)
		{
			mysqli_query($conn, "INSERT INTO `kiusc_emp_designations`(`emp_id`, `designation_id`, `acc_department_id`, `adm_department_id`, `date_of_joining`, `service_end_date`, `employment_nature`, `contract_period_months`, `mode_of_employment`, `employment_scale`, `pay_scale`,`is_current`,`is_initial`) VALUES ('$emp_id','$designation_id','$acc_department_id','$adm_department_id','$date_of_joining','$service_end_date','$employment_nature','$contract_period_months','$mode_of_employment','$employment_scale','$pay_scale','$is_current','1')");
		}
...
<input type="hidden" name="emp_id" value="<?php echo isset($emp['id']) ? $emp['id'] : "" ?>">
	...
	<tr>
		...
		<td> 
		<img src="<?php echo isset($emp['picture']) ? 'newfiles/hr/pictures/'.$emp['picture'] : 'newfiles/hr/pictures/pic.jpg' ?>" style="width: 150px; height: 200px;border: 5px solid;" id="file-ip-1-preview" />
	...
	<tr>
		...
		<td> <input type="text" name="account_no" style="width:500px"  value="<?php echo isset($emp['account_no']) ? $emp['account_no'] : "" ?>" /> </td>
	</tr>
	...
	if($emp_desg['is_current'] == 1 && $emp_desg['is_initial'] == 1)
		$checked="Checked";
...
<tr>
	...
	<td><input type="date" style="width:500px" name="date_of_joining" id="date_of_joining" onchange="calEndDate()" value="<?php echo isset($emp['date_of_joining']) ? $emp['date_of_joining'] : $date ?>"></td>
...
<tr id="period_tr" style="width:500px" <?php echo isset($emp['employment_nature']) ? (($emp['employment_nature']=="Regular") ? "hidden" : "") : "hidden" ?>>
	...
	<td><input type="number" name="contract_period_months" id="contract_period_months" onkeyup="calEndDate()" value="<?php echo isset($emp['contract_period_months']) ? $emp['contract_period_months'] : "1" ?>"></td>
</tr>
<style>
...
<tr>
	...
	<td><input type="date" style="width:500px" name="service_end_date" id="service_end_date" readonly value="<?php echo isset($emp['service_end_date']) ? $emp['service_end_date'] : "" ?>"></td>
</tr>
<tr>
	...
	<tr>
			...
			<td> <input type="checkbox" name="is_payroll" style="width:500px" value="1" <?php echo $payroll_chk ?>/> </td>
		</tr>
	<tr>
	<tr>
			<td> Is Active? </td>
