...
if(isset($_POST['add_education']) || isset($_POST['submit']))
{
	$is_highest=0;
...
<input type="hidden" name="emp_id" value="<?php echo isset($emp_id) ? $emp_id : "" ?>">
	...
	<table id="tbl" style="border-collapse: inherit;border: 1px solid; border-spacing: 1px; width:80%">
		...
		<td></td>
		<td>
			<input type="submit" name="add_education" value="Add Education" style="background-color: burlywood; border-radius: 17px; color: black;float:right" />
		</td>	
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<tr>
			<td>
				...
				<input type="submit" name="submit" value="Submit" style="background-color: burlywood; border-radius: 17px; color: black;" /></td>
			<td></td>
		</tr>
	</table>
</form>
