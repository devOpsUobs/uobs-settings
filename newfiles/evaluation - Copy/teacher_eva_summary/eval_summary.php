...
echo "Select Evaluation: "; $evl_id = evalDropDown($conn, $evl_id);
...
<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="exportDetail()">Download Report</a>
 ...
 <form id="fm1" method="post" action="<?php echo JURI::root( true ) ?>/newfiles/evaluation/teacher_eva_summary/msExcelExport.php" target="_blank">
