...
$sql = "INSERT INTO `kiusc_evaluation`(`description`, `start_date`, `end_date`, `sem_id`, `enable_std`, `active`) VALUES ('$description', '$start_date', '$end_date', '$sem_id', '$enable_std', '$active')";
