...
$sql = "UPDATE `kiusc_evaluation` SET `description`='$description', `start_date`='$start_date', `end_date`='$end_date', `sem_id`='$sem_id', `enable_std`='$enable_std', `active`='$active' WHERE id=$id";
