...
?>
	...
	<script type="text/javascript">
			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						border:false,
						cache:true,
						href:'<?php echo JURI::root( true ) ?>/newfiles/evaluation/add_question_categories/form_categories.php?index='+index,
						onLoad:function(){
		...
		function saveItem(index){
			...
			var url = row.isNewRecord ? '<?php echo JURI::root( true ) ?>/newfiles/evaluation/add_question_categories/save_categories.php' : '<?php echo JURI::root( true ) ?>/newfiles/evaluation/add_question_categories/categories.php?id='+row.id;
			...
			if (row){
				$.messager.confirm('Confirm','Are you sure you want to remove this category?',function(r){
					if (r){
						...
						$.post('<?php echo JURI::root( true ) ?>/newfiles/evaluation/add_question_categories/delete_categories.php',{id:row.id},function(s){
...
<body>
	...
	<table id="dg" title="My Users" style="width:900px;height:450px"
			url="<?php echo JURI::root( true ) ?>/newfiles/evaluation/add_question_categories/get_categories.php"
