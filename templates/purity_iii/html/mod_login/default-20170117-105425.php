	...
	<div class="userdata">
		...
		<?php
			...
			<?php endif; ?>
				...
				<?php //echo JRoute::_('index.php?option=com_users&view=reset&Itemid=' . UsersHelperRoute::getResetRoute()); ?>
					<a href="index.php/cms-admin/ldap-create-account/forget-password">
